    ...
    try {
      ...
      const result = await suggestAlternativeMeals({
        ...
        availableIngredients:
          'Rice, lentils, seasonal vegetables, basic spices', // Placeholder
    ...
    <>
      <Card className="shadow-md">
        <CardHeader>
          ...
          <CardDescription>
            Check off meals as you complete them. Need a change? Ask for
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[480px]">
          <DialogHeader>
            ...
            <DialogDescription>
              AI-powered suggestions based on your profile and available
              ingredients.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                    {suggestions.alternativeMeals.map((meal, i) => (
                      <li key={i}>{meal}</li>
                    ))}
                  </ul>
                </div>
